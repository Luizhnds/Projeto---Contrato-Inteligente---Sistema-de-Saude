...
2. Criar arquivo "SistemaSaude.sol"
3. Colar o conteúdo do arquivo disponível no github
4. Compilar usando 0.8.30
5. Deploy usando Remix VM (London)
6. O endereço que fizer o deploy será o proprietário
